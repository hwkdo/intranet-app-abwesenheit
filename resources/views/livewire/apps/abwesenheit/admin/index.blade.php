...
title('Abwesenheit - Admin');

state(['activeTab' => 'hintergrundbild']);

?>

<x-intranet-app-abwesenheit::abwesenheit-layout heading="Abwesenheit App" subheading="Admin">
    <flux:tab.group>
        ...
        <flux:tab.panel name="einstellungen">
            <div style="min-height: 400px;">
                @livewire('intranet-app-base::admin-settings', [
                    'appIdentifier' => 'abwesenheit',
                    'settingsModelClass' => '\Hwkdo\IntranetAppAbwesenheit\Models\IntranetAppAbwesenheitSettings',
                    'appSettingsClass' => '\Hwkdo\IntranetAppAbwesenheit\Data\AppSettings'
                ])
            </div>
        </flux:tab.panel>
            ...
            <div style="min-height: 400px;">
                <flux:card>
                    ...
                    <flux:text class="mb-6">
                        Übersicht über die Nutzung der Abwesenheit App.
                    </flux:text>
